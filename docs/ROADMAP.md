...
| RM-008 | High | planned | Exam discoverability | Surface exact exam-match snippets in the right topic rails, reduce critical reliance on `additional`, and evaluate making high-value `ai_summary` content selectable. | [RM-008](./specs/RM-008-exam-snippet-discoverability.md) |
